...
- Name: Zugriff auf geschützte Downloads >> Benutzer "andi" kann auf seine Downloads zugreifen
- Location: C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:65:3
...
Call log:
  - navigating to "http://localhost:8080/downloads/andi/leitfaden_umgang_nps.pdf", waiting until "load"
    ...
    at C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:69:16
```
