...
- Name: Zugriff auf geschützte Downloads für weitere Nutzer >> Benutzer "sonstwer" kann auf seinen Download zugreifen
- Location: C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:155:5

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:8080/downloads/sonstwer/datei_sonstwer.pdf
Call log:
  - navigating to "http://localhost:8080/downloads/sonstwer/datei_sonstwer.pdf", waiting until "load"

    at C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:158:18
```
...
```ts
   ...
   61 | });
   62 |
   63 | test.describe('Netlify Redirect-Regeln für Benutzerrolle "ricardo"', () => {
