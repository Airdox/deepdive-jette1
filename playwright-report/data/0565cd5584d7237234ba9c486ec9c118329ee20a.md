...
- Name: Zugriff auf geschützte Downloads >> Benutzer ohne Berechtigung wird beim Zugriff auf Downloads weitergeleitet
- Location: C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:76:3

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:8080/downloads/andi/leitfaden_umgang_nps.pdf
Call log:
  - navigating to "http://localhost:8080/downloads/andi/leitfaden_umgang_nps.pdf", waiting until "load"

    at C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:80:16
```
