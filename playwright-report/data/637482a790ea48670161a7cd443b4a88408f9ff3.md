...
- Name: Zugriff auf geschützte Downloads für weitere Nutzer >> Benutzer "mareen" kann auf seinen Download zugreifen
- Location: C:\Users\User\Desktop\Meine projekete\dein-projekt\tests\redirects.spec.js:155:5

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://localhost:8080/downloads/mareen/datei_mareen.pdf
Call log:
  - navigating to "http://localhost:8080/downloads/mareen/datei_mareen.pdf", waiting until "load"
